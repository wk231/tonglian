  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(t.order.title, style: const TextStyle(color: Colors.black)),
        centerTitle: true,
        elevation: 0,
      ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                order.totalAmount != null ? (order.totalAmount! / 100).toStringAsFixed(2) : t.order.statuses.unknown,
                                style: const TextStyle(
                                  fontSize: 21,
                                  fontWeight: FontWeight.w500,
                                  color: Color(0xFFFF0000),
                          ...
                          const Divider(color: Color(0xFFE6E6E7), height: 1),
                          const SizedBox(height: 10),
                          // 支付周期
                          Text(
